import { Flag as FlagIcon, Timer, Trophy } from 'lucide-react';
import type { RaceFull, ResultadoEstado } from '../../lib/types';
...
/** Clase del badge de estado para filas que no terminaron. */
...
/** Detalle de un GP: pole, vuelta rápida y clasificación completa. */
export function F1RaceResult({ race }: F1RaceResultProps) {
  return (
    <section className={styles.detalle}>
      <header className={`${styles.cabecera} texture`}>
        <span className="kicker">Resultado · Ronda {race.ronda}</span>
        ...
        <table className={styles.tabla}>
          <thead>
            <tr>
              ...
              <th className={styles.colPiloto} scope="col">Piloto</th>
